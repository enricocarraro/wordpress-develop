		...
		copy: {
			...
			'includes-js': {
				files: {
					...
					[ WORKING_DIR + 'wp-includes/js/edit-events.js' ]: [ './src/js/_enqueues/lib/edit-events.js' ],
					...
					[ WORKING_DIR + 'wp-includes/js/metabox-events.js' ]: [ './src/js/_enqueues/wp/media/metabox-events.js' ],
