...
<input name="noapi" type="hidden" value="1" /><?php } ?>
	...
	case 2:
		...
		$tryagain_link = '</p><p class="step"><a id="try-again-link" href="' . $step_1 . '" class="button button-large">' . __( 'Try Again' ) . '</a>';
...
<textarea id="wp-config" cols="98" rows="15" class="code not-writable" readonly="readonly"><?php echo $config_text; ?></textarea>
...
?>
<?php wp_print_scripts( array( 'language-chooser', 'setup-config' ) ); ?>
</body>
</html>
